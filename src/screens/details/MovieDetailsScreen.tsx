...
import { TVDetailsSkeletonScreen as MovieDetailsSkeletonScreen } from './skeleton';
import { TVDetailsError as MovieDetailsError } from '../../common/components/details/errors';
import { Video, WatchProviders } from '../../types/tv';
import {
  getVideoUrl,
  formatRuntime,
} from '../../common/utils/movieDetails';
...
const MovieDetailsScreen: React.FC = () => {
  ...
  if (error) {
    return (
      <MovieDetailsError
        message={error}
        onRetry={() => navigation.replace('MovieDetail', { id })}
  ...
  if (!movieDetails) {
    return (
      <MovieDetailsError
        message="No information available for this movie"
        onRetry={() => navigation.replace('MovieDetail', { id })}
        onBack={() => navigation.goBack()}
        theme={theme}
      />
